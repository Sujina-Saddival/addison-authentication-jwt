...
def applicationName = 'jwt-authentication'
def applicationPortInContainer = 8443
def dcosApplicationServicePath = 'your-github-organization/jwt-authentication'
def dockerImageRepo = 'your-github-organization/jwt-authentication'
def ucpGroupLabel = 'your-github-organization'
def vaultPath = 'secret/your-github-organization/jwt-authentication'
...
def createRepoRequest = [
    ...
    shortDescription: 'Protecting the route using jwt',
    longDescription : 'Protecting the route using jwt',
    visibility      : 'public',
    scanOnPush      : true
]
